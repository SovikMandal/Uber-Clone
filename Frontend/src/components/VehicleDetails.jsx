...
const VehicleDetails = (props) => {
  ...
  return (
    <div>
      <h5
        onClick={() => {
          props.setVehicleDetailsPanel(false);
        }}
      ...
      <div className="flex flex-col gap-5 w-full items-center justify-center">
        <h3 className="text-2xl font-bold pt-2">Confirm your {vehicle.name}</h3>
        ...
        <button
          ...
          className="w-full mt-2 p-3 bg-green-600 text-xl rounded-lg text-white font-semibold"
        >
          Confirm
        </button>
      </div>
